...
contract HedgerDex is AccessControl, ERC20("HedgerDex Token", "HDT") {
    ...
    constructor() {//address _stablecoin, AggregatorV3Interface _stablecoinPriceFeed
    ...
    function swapOnPrice1inch(
        ...
        SafeERC20.safeApprove(IERC20(_toToken), msg.sender, returnAmount);
    ...
    // Add this function to HedgerDex.sol
...
/*
    ...
    function executeProposal(uint256 _proposalId) public {
        ...
        require(getTokenPrice(address(stablecoin)) <= (1 + maxPriceImpact) * getExpectedTokenPrice(address(stablecoin), stablecoinBalance), "Price impact too high");


        // Swap stablecoin for targetToken using 1inch
        swapTo1inch(address(stablecoin), p.targetToken, stablecoinBalance, targetTokenAmount, maxPriceImpact);
